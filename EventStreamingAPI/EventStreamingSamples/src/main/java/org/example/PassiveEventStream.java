...
/*
 Start this file as ```java PassiveEventStream.java -XX:StartFlightRecording```
 Then using EventStream.openRepository() it will look for the recording in it and start EventStream on that recording.
*/
public class PassiveEventStream {
    static int NUMBER_CPULOAD_EVENTS = 5;
